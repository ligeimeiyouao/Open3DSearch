...
<div align="center"><img width="1000" height="500" alt="image" src="https://github.com/user-attachments/assets/28cdb7dc-33ba-4afb-b731-9bfb6974369d" />
 ...
 <p>数据集下载完成后，你需要运行<a href="https://github.com/ligeimeiyouao/Open3DSearch/blob/main/data_preprocessing/download_glbs.py">download_glbs.py</a>下载glb文件（默认下载到设备根目录的.objaverse文件夹中）。除此之外，我们还提供了三维形状的特征提取代码<a href="https://github.com/ligeimeiyouao/Open3DSearch/blob/main/data_preprocessing/3d_shape_feature_extraction.py">3d_shape_feature_extraction.py</a></p>
